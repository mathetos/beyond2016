 ...
 */
 ...
 function beyond2016_give_layout_options( $post )
   { ?>
     ...
     <fieldset>
      <legend for="beyond2016_give_sidebar_layout" id="beyond2016_give_sidebar_layout"><strong><?php _e( "Sidebar", 'beyond2016' ); ?></strong></legend>

      <label for="beyond2016-give-sidebar-disable">
        <input type="radio" name="beyond2016-give-sidebar-layout" id="beyond2016-give-sidebar-disable" value="disable" <?php if ( isset ( $beyond2016_page_meta['beyond2016-give-sidebar-layout'] ) ) checked( $beyond2016_page_meta['beyond2016-give-sidebar-layout'][0], 'disable' ); ?>>
        <?php _e( "Disable the Sidebar", 'beyond2016' ); ?>
      </label><br />

      <label for="beyond2016-give-sidebar-right">
        <input type="radio" name="beyond2016-give-sidebar-layout" id="beyond2016-give-sidebar-right" value="right" <?php if ( isset ( $beyond2016_page_meta['beyond2016-give-sidebar-layout'] ) ) checked( $beyond2016_page_meta['beyond2016-give-sidebar-layout'][0], 'right' ); ?>>
        <?php _e( "Right-hand Sidebar", 'beyond2016' ); ?>
      </label><br />

      <label for="beyond2016-give-sidebar-left">
        <input type="radio" name="beyond2016-give-sidebar-layout" id="beyond2016-give-sidebar-left" value="left" <?php if ( isset ( $beyond2016_page_meta['beyond2016-give-sidebar-layout'] ) ) checked( $beyond2016_page_meta['beyond2016-give-sidebar-layout'][0], 'left' ); ?>>
        <?php _e( "Left-hand Sidebar", 'beyond2016' ); ?>
      </label>
     </fieldset>

     <fieldset>
      <legend for="beyond2016_hide_give_elements" id="beyond2016_hide_give_elements"><strong><?php _e( "Hide Elements", 'beyond2016' ); ?></strong></legend>
      <label for="disable-give-title">
         ...
         <label for="hide-give-footer">
             <input type="checkbox" name="hide-give-footer" id="hide-give-footer" value="yes" <?php if ( isset ( $beyond2016_page_meta['hide-give-footer'] ) ) checked( $beyond2016_page_meta['hide-give-footer'][0], 'yes' ); ?> />
             <?php _e( 'Hide the Footer?', 'beyond2016' )?>
         </label>
   ...
   function save_beyond2016_give_layout_options( $post_id, $post, $update ) {
     ...
     // Save Sidebar Layout Option
     if( isset( $_POST[ 'beyond2016-give-sidebar-layout' ] ) ) {
         update_post_meta( $post_id, 'beyond2016-give-sidebar-layout', $_POST[ 'beyond2016-give-sidebar-layout' ] );
     }
     ...
     // Save Hide Footer Page Option
     if( isset( $_POST[ 'hide-give-footer' ] ) ) {
       update_post_meta( $post_id, 'hide-give-footer', 'yes' );
     } else {
         update_post_meta( $post_id, 'hide-give-footer', '' );
     }
