 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Beyond2016
...
add_action( 'tgmpa_register', 'beyond2016__register_required_plugins' );
 ...
 */
function beyond2016__register_required_plugins() {
	/*
	...
	$config = array(
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'beyond2016' ),
			'menu_title'                      => __( 'Install Plugins', 'beyond2016' ),
